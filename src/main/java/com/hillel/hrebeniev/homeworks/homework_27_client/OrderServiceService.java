 ...
 *
 */
@WebServiceClient(name = "OrderServiceService", targetNamespace = "http://service.hillel.edu/", wsdlLocation = "http://localhost:9999/orders?wsdl")
        ...
        extends Service
{
    ...
    private final static QName ORDERSERVICESERVICE_QNAME = new QName("http://service.hillel.edu/", "OrderServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/orders?wsdl");
    ...
    public OrderService getOrderServicePort() {
        return super.getPort(new QName("http://service.hillel.edu/", "OrderServicePort"), OrderService.class);
    }
    ...
    public OrderService getOrderServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.hillel.edu/", "OrderServicePort"), OrderService.class, features);
    }
